...
//         .range([0, (deadliftUpdatedData.length * 50)-40]);

//     var y = d3.scale.linear()
//         .range([(Array.max(deadlift_heightPoints) ), 50]);
...
//     deadlift_svg.append("g")
//         .attr("class", "x axis")
//         .attr("transform", "translate(50," + (Array.max(deadlift_heightPoints)) + ")")
//         .call(xAxis);
